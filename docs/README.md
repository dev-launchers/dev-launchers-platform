...
This is the monorepo documentation for all DevLaunchers internal products, we use React.js/Next.js and many other wonderful libraries.
...
[As a technical lead](getting-started/as-a-tech-lead)

[As a developer](getting-started/as-a-developer)
