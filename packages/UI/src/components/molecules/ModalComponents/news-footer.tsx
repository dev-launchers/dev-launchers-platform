...
const newsFooter =  (
        ...
        <div className="text-grayscale-800 text-center relative text-base font-normal font-['NunitoSans'] capitalize leading-normal tracking-wide">
          Dismiss
        </div>
      </button>
      <button className="bg-brand-alt-nebula-600 rounded-lg border-solid border-brand-secondary-nebula-600 border pt-2 pr-6 pb-2 pl-6 flex flex-row gap-2.5 items-center justify-center shrink-0 relative">
        <div className="text-center text-grayscale-50 text-base font-normal font-['NunitoSans'] capitalize leading-normal tracking-wide">
          Subscribe
        </div>
      </button>
      </div>
