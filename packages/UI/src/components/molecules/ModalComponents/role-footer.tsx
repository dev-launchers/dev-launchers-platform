...
<div
    ...
    >
      ...
      <div className="flex flex-row gap-6 items-start justify-end shrink-0 relative">
        <div className="bg-grayscale-50 rounded-lg border-solid border-grayscale-800 border-2 pt-2 pr-6 pb-2 pl-6 flex flex-row gap-2.5 items-center justify-center shrink-0 relative">
          <div
