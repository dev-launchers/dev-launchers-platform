...
export const styles = {
  ...
  size: {
    micro3: 'text-[clamp(0.521rem,calc(0.5rem+0.25vw),0.579rem)]',
    micro2: 'text-[clamp(0.625rem,calc(0.6rem+0.25vw),0.694rem)]',
    micro_xs: 'text-[clamp(0.75rem,calc(0.7rem+0.25vw),0.833rem)]',
    body_sm: 'text-[clamp(0.875rem,calc(0.825rem+0.25vw),1rem)]',
    body_base: 'text-[clamp(1rem,calc(0.95rem+0.25vw),1rem)]',
    body_lg: 'text-[clamp(1.125rem,calc(1.075rem+0.25vw),1.2rem)]',
    body_xl: 'text-[clamp(1.25rem,calc(1.2rem+0.25vw),1.44rem)]',
