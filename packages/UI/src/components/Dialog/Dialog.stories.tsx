 ...
 * Description export is an wrapper to add a description to the dialog for accessibility.
      ...
      <>
        <Dialog>
          ...
          <DialogContent>
            ...
            <div className="my-8 h-36 w-96 bg-grayscale-200"></div>
...
//     );
//     const EmptyHeader = (
//       <h3 className="h-8 w-full"> </h3>
//     );
//     const EmptyContent = <div className="h-36 w-full bg-grayscale-100"></div>;
//     const EmptyFooter = <div className="h-10 w-full"></div>;
...
// export const NewsletterNoCloseButton: Story = {
//   render: () => {
//     const NewsletterTriggerBtn = (
//       <Button buttonType="primary" buttonSize="standard">
//         Subscribe!
