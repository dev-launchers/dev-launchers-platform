        ...
        <PageBody>
          ...
          <span style={{ color: "red", fontWeight: "bold", fontSize: ".9rem" }}>
            * This page is under construction, and the point values and rewards
            listed are NOT final! Point to reward ratios will be adjusted, and
            new ways to earn points are being added
          </span>
          <hr />
          <h2>Spend points</h2>
          ...
          <h2>Earn points</h2>
          {
            ...
            >
              <tbody>
                <tr
                  style={{ fontWeight: "bold", fontFamily: "Holtwood One SC" }}
                >
                  <td>For Everyone</td>
                </tr>
                {(function() {
                  // Group our entries by category first, then output
                  let categories = rewards.tasks.reduce(
                    (categoryMemo, entry) => {
