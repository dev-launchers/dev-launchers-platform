...
export default function Create(props) {
    ...
    const [templateDescription, setTemplateDescription] = React.useState("TEMP DESCRIPTION");
        ...
        for (let tabKey of tabs) {
            ...
            for (let sectionKey of sections) {
                ...
                for (let groupKey of groups) {
                    const cards = Object.keys(createPageData[tabKey][sectionKey][groupKey]);
                    for (let cardKey of cards) {
                        const thisCard = createPageData[tabKey][sectionKey][groupKey][cardKey];
    ...
    return (
        <PageBody>
            ...
            >
                <h2 style={{ marginTop: "0%", paddingTop: "0%" }}>{templateTitle} Game Template</h2>
                <div
                    style={{
                        display: "flex"
                    }}
                >
                    ...
                    >
                        ...
                        <div style={{ width: "80%", marginTop: "2%" }}>{templateDescription}</div>
                    </div>
                    <div style={{ width: "40%" }}>
                        <div>
            ...
            <div className="page-description">
                These templates are where projects begin. They provide the generic structure and base logic, so you can
