...
const communityCards = [
  {
    title: "DISCORD",
    description:
      "If you want to bean integral part of an international platform with over 850 members to learn project management and app development on the go, join our Discord server",
