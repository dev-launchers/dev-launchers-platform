...
export const Image = styled.img`
  height: 100%;
  filter: drop-shadow(-0.075rem 0rem 0 ${theme.colors.NEUTRAL_2})
    drop-shadow(0rem -0.075rem 0 ${theme.colors.NEUTRAL_2})
    drop-shadow(0.15rem 0rem 0 ${theme.colors.NEUTRAL_2}) grayscale(100%);
