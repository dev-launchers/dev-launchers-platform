    ...
    return (
        <PageBody>
            ...
            <div style={{ marginBottom: "2%" }}>
                We hold virtual sessions <b>every Saturday from 12-5pm CDT.</b>{" "}
                Wanna join?? Sign up{" "}
                <a
            ...
            <div>
                Click one of the rooms below to open up a <u>Google Hangouts</u>{" "}
                video chat or <u>Mozilla Hubs</u> virtual room! Our sessions
                begin in the <b>Common Area</b>, and then team and individual
                help happens in the side rooms
            </div>
            <Building />
            <div className="infoArea">
                <h3>Session Checklist</h3>
                For students participating in virtual sessions, you'll need to
                have a few different tabs open:
                <ul>
                    <li>
                        <b>This Page</b>
                    </li>
...
function Room({ className, roomData, roomKey, setRoomActive }) {
    ...
    return (
        <div
            className={[
                className,
                roomData.isActive ? style.activeRoom : ""
            ].join(" ")}
