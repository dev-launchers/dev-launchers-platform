...
export default function MemberProfilesSlideshow(props) {
    ...
    React.useEffect(() => {
        setCareerColumn1(careerCategories[wrapIndex(careerIndex, careerCategories)]);
        setCareerColumn2(careerCategories[wrapIndex(careerIndex - 1, careerCategories)]);
        setCareerColumn3(careerCategories[wrapIndex(careerIndex - 2, careerCategories)]);
