// Copied from node_modules/@strapi/plugin-users-permissions/server/services/providers-registry.js
// Changed google to get userinfo instead of token info and insert new profile
'use strict';
