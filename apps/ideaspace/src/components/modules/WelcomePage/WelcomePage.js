  ...
  return <>
    <HeadWapper>
      ...
      <atoms.Typography type='h4' >
        ...
        LET'S GET STARTED
        <RocketImage src={rocketImage.src} />
      </atoms.Typography>
    </HeadWapper>
      ...
      <ButtonArea>
        <Link href="/ideaspace/submit">
          ...
          <IdeaspaceNavCard
            ...
            cardBackgroundImage={bulletinBoardPostItImage.src}
        ...
        <Link href="/ideaspace/browse">
          ...
          <IdeaspaceNavCard
            ...
            cardBackgroundImage={helpButtonImage.src}
        ...
        <IdeaGeneratorButton showExtendedContent>
          <IdeaspaceNavCard
            ...
            cardBackgroundImage={handWithLightbulbImage.src}
