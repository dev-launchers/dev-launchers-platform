...
const Projects = ({ projects }) => {
  ...
  return (
    ...
    >
      ...
      <div>
				Come together to contribute, collaborate, and excel! Access a wealth of resources, tools, and support designed to help you succeed in building projects in the Dev Launchers ecosystem. <a href="/join">Find a place you fit!</a>
			</div>
      <Layout>
        {items?.map((project, i) => {
          ...
          <ProjectContainer key={i}>
            <Card
              ...
              cardData={{
                ...
                imageSrc: imageUrl,
                actions: <a href={`${urlPathname}/${project.attributes.slug}`}>LEARN MORE</a>
              }}
            />
          </ProjectContainer>
          )
