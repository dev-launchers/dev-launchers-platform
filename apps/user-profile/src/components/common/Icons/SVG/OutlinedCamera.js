/**
 * OutlinedCamera Component
 * Renders an SVG camera icon with a customizable outline and dynamic properties.
 *
 ...
 * @param {string} [props.colorClass='fill-grayscale-400'] - CSS class to set the fill color of the camera outline.
 ...
 *
 * @example
 * <OutlinedCamera width={24} height={24} colorClass="fill-blue-500" svgClass="custom-class" />
 * <OutlinedCamera />
 *
 * @returns {JSX.Element} The rendered outlined camera SVG.
 */
function OutlinedCamera({ width, height, colorClass, svgClass }) {
  return (
    // SVG container for the camera icon
    <svg
      ...
      viewBox="0 0 18 16" // Defines the SVG's internal coordinate system
