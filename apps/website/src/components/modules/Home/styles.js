export const styles = {
  ...
  section: {
    ...
    communityCardContainer:
      'flex flex-col md:flex-row gap-6 pt-16 max-w-7xl mx-auto',
    ...
    container:
      'container max-w-7xl flex flex-col pb-20 justify-center items-center px-4 pt-20 md:px-6 py-12',
    ...
    headerHero:
      'flex flex-col items-center justify-center w-full max-w-7xl text-center pt-16 pb-4',
