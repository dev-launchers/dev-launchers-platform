          ...
          <section className="max-w-7xl bg-black py-32 px-4 md:px-8 ">
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="text-xl text-center max-w-3xl  text-gray-500  font-normal">
                Help Dev Launchers provide resources and opportunity for
                developers, creatives, and innovators from diverse backgrounds
                to gain the skills and knowledge necessary to launch their
          ...
          <section className="max-w-full bg-black py-24 px-4 md:px-8">
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="text-lg text-center max-w-3xl  text-gray-500  font-normal">
                ...
                diverse creatives, innovators, and leaders. We're working on
          ...
          <section className="max-w-full bg-black py-24 px-4 md:px-8">
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="text-lg text-center max-w-3xl  text-gray-500  font-normal">
                ...
                mentorship, and opportunities to those who are eager to learn
                and grow in their careers. Whether you are a company, a
                professional group, or an individual with a passion for
                technology and education, your support is crucial in building a
                more inclusive and diverse tech community.
              </p>
          ...
          <section className="max-w-full bg-black py-24 px-4 md:px-8">
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="text-lg text-center max-w-4xl  text-gray-500  font-normal">
                Share your expertise and inspire tech enthusiasts at every
                career stage by becoming a mentor at Dev Launchers. As a mentor,
                you play a crucial role in helping our diverse members navigate
                the complexities of technology and design, guiding them to the
                next level in their careers. Your involvement not only shapes
                their professional journey but also enhances your leadership and
                teaching skills within a collaborative and supportive
                environment. Whether you're leading workshops or guiding a team,
                your contribution helps turn potential into significant career
                growth. Join us to foster a space where every interaction is an
                opportunity for mutual learning and every challenge a chance to
                advance together.
              </p>
              <div className="flex flex-wrap gap-8 pt-8">
                <a
