  ...
  return (
    <>
      ...
      <div>
        <PageBody>
          <br />
          <Typography type="h1" textAlign="center" className="mb-6">
            Join in on our events!
          </Typography>
          <Typography
            type="pLarge"
            textAlign="center"
          ...
          >
            Dev Launchers is being built from the ground up to provide resources
            and fun activities for our growing community of developers and
            creatives. Get help on a project, test your skills, help someone
            grow their own skills, and join a fun community of like-minded
            people building things during one of our events or 1 on 1 help
            sessions!
          </Typography>
          <br />
          <Typography type="h3" textAlign="center" className="mb-6">
            Community Calendar
          </Typography>
          <iframe
