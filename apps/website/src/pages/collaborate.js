      ...
      <main className="min-h-screen bg-black text-white">
        <section className="max-w-full bg-black py-32 px-4 md:px-8">
          ...
          <p className="text-xl text-left max-w-3xl  text-gray-500  font-normal">
            Collaborate with us to build real-world projects and gain invaluable
            experience. Whether you're a beginner or a seasoned professional
        ...
        <section className="max-w-full py-24 px-4 md:px-8">
          ...
          <p className="text-lg text-left max-w-4xl text-gray-500 font-normal">
            ...
            understand that everyone has different goals and availability, which
            is why we offer a variety of membership pathways to support each
            member uniquely. Select your path at Dev Launchers with our tailored
            membership levels. We have a place for you whether you want to grow
            independently in our Orbit, transition between levels as a Traveler,
            or empower our core initiatives. Explore the options:
          </p>
          <div className="grid pt-8 gap-4 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div className="bg-yellow-900 border-yellow-500 border-4 p-6 rounded-lg">
              ...
              <p className="text-base text-left text-yellow-200 font-normal">
                Take a central role in our projects, working regularly as a team
                member or leader on impactful software projects. This path
                accelerates your growth through hands-on, cross-functional team
                experiences.
              </p>
            </div>
          </div>
        ...
        <section className="max-w-full py-24 px-4 md:px-8">
          ...
          <p className="text-lg text-left max-w-4xl  text-gray-500  font-normal">
            Members brainstorm, propose, and workshop on software project ideas.
            Got a groundbreaking idea? Bring it to our community and see it take
            shape!
          </p>
        ...
        <section className="max-w-full py-24 px-4 md:px-8">
          ...
          <p className="text-lg text-left max-w-4xl  text-gray-500  font-normal">
            Create your profile and connect with like-minded individuals in our
            vibrant community. Engage with other members, share your journey,
            and find partners for your next project. Networking at Dev Launchers
            opens doors to opportunities and collaborations.
          </p>
          <div className="flex pt-8">
            <a
              className="bg-purple-900 border-2 border-purple-400 text-base text-white font-normal capitalize py-3 px-6 rounded-xl transition-all duration-200 hover:text-purple-900 hover:font-semibold  hover:bg-purple-500 hover:border-purple-300 hover:border-4"
        ...
        <section className="max-w-full py-24 px-4 md:px-8">
          ...
          <p className="text-lg text-left max-w-4xl  text-gray-500  font-normal">
            Utilize our comprehensive library of resources, templates, and tools
            to enhance your skillset. From beginner to advanced levels, our
            learning materials are designed to support your growth in the most
            dynamic industries.
          </p>
          <div className="flex pt-8">
            <a
