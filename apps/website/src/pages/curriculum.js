...
const Card = ({ children, className = '', hover = true }) => (
  <div
    className={`bg-black backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 ${
      hover
        ? 'transition-all duration-300 hover:border-blue-500/50 hover:bg-black'
        : ''
    } ${className}`}
  >
    {children}
...
const CTAButton = ({ href = '#', children, variant = 'primary' }) => {
  ...
  return (
    <Link
      href={href}
      className={`inline-flex items-center justify-center rounded-lg px-4 py-2 text-sm font-medium transition-colors ${variants[variant]}`}
    >
      {children}
    </Link>
  );
...
export default function CreateRoute() {
  ...
  const glance = [
    {
      icon: '🌐',
      title: 'Format',
      detail: 'Remote, mentor-led, project-based',
    },
    {
      icon: '⏱️',
      title: 'Cadence',
      detail: '4-week sprints (plan → build → review → retro)',
    },
    {
      icon: '🗓️',
      title: 'Sessions',
      detail:
        'Two 1-hour live collaboration sessions weekly (Central Time), plus async work',
    },
    { icon: '⌛', title: 'Time', detail: '~5–10 hours/week minimum' },
    {
      ...
      title: 'Teams',
      detail:
        'Cross-functional product teams (Design, Development, Research, Product Management)',
    },
    {
      icon: '🧰',
      title: 'Tools',
      detail:
        'Figma, GitHub, React/TypeScript, Storybook, GitBook, Discord, Google Workspace, Strapi',
    },
    {
      icon: '🎓',
      title: 'Cost',
      detail: 'Tuition $0 (nonprofit) — see Admissions & Tuition',
    },
  ];
  ...
  const rhythm = [
    {
      icon: '🧑‍🏫',
      text: 'Department Collaboration (1 hr): progress review, technique demos (e.g., prototyping, design systems, accessibility), critique, next steps.',
    },
    {
      icon: '🤝',
      text: 'Cross-Department Collaboration (1 hr): Design × Research × Product × Dev working session (flows, wireframes, prototypes, implementation reviews).',
    },
    {
      icon: '🧵',
      text: 'Async Work (3–8 hrs): issues in GitHub, branch/PR workflow, check-ins on Discord, optional pairing and office hours.',
    },
  ];
  ...
  const sprintCycle = [
    {
      title: 'Plan',
      description:
        'Scope goals, estimate issues, set acceptance criteria and dependencies.',
    },
    {
      title: 'Build',
      description:
        'Execute assignments, mid-sprint check-ins, research as needed.',
    },
    {
      title: 'Review',
      description:
        'Demos, QA, research readouts; align design ↔ dev; merge/ship.',
    },
    {
      title: 'Retro',
      description:
        'FigJam retrospective; action items feed the next sprint plan.',
    },
  ];
  ...
  const pathways = [
    {
      ...
      artifacts:
        'Component sets in Figma, interaction prototypes, system tokens, acceptance-criteria-aligned specs.',
    },
    {
      icon: '💻',
      name: 'Development',
      ...
      artifacts:
        'Merged PRs, Storybook stories, test coverage, issue → PR traceability.',
    },
    {
      icon: '🔬',
      name: 'Research',
      ...
      artifacts:
        'Study plans, highlight reels/notes, insight → recommendation readouts tied to backlog items.',
    },
    {
      icon: '📈',
      ...
      artifacts:
        'Roadmaps, prioritized backlogs, KPI dashboards, sprint reports.',
    },
  ];
  ...
  const feedbacks = [
    {
      icon: '🎯',
      title: 'SMART Goals',
      detail: 'Set at onboarding with your mentor; reviewed quarterly.',
    },
    {
      icon: '🔁',
      title: 'In-sprint Feedback',
      detail:
        'Critiques, PR reviews, and readouts provide continuous guidance.',
    },
    {
      icon: '📍',
      title: 'Checkpoints',
      detail: 'Mentors track progress toward outcomes and adjust assignments.',
    },
    {
      icon: '🕒',
      title: 'Participation',
      detail:
        'Target ≥ 80% attendance for required live/async touchpoints to stay on a team.',
    },
  ];
  ...
  const tools = [
    {
      ...
      description:
        'Design systems, prototypes, critiques, and retros with collaborative canvases.',
    },
    {
      icon: '📦',
      name: 'GitHub',
      ...
      description:
        'Issues, Projects, Pull Requests, and CI for tracking work and reviews.',
    },
    {
      icon: '⚛️',
      ...
      description:
        'Front‑end implementation with typed components and accessible UI.',
    },
    {
      icon: '📚',
      name: 'Storybook',
      ...
      description:
        'Component documentation and manual a11y checks for shared UI.',
    },
    {
      icon: '📖',
      name: 'GitBook',
      ...
      description:
        'Public docs and curriculum hosting for reference and onboarding.',
    },
    {
      icon: '💬',
      name: 'Discord',
      ...
      description:
        'Daily communication, async updates, and pairing/office hours.',
    },
    {
      icon: '🧮',
      name: 'Google Workspace',
      href: 'https://workspace.google.com',
      description: 'Docs, Sheets, and Slides for planning and readouts.',
    },
    {
      icon: '🗄️',
      name: 'Strapi',
      href: 'https://strapi.io',
      description: 'Headless CMS powering content‑driven features.',
    },
  ];
  ...
  const outcomes = [
    {
      ...
      detail:
        'Work products that reflect real collaboration across disciplines.',
    },
    {
      icon: '🧭',
      title: 'Proficiency with tools',
      detail: 'Comfort with industry-standard tooling and workflows.',
    },
    {
      icon: '🤝',
      title: 'Cross-functional experience',
      detail: 'Operate within agile, cross‑discipline teams.',
    },
    {
      icon: '✅',
      title: 'Mentor verification',
      detail: 'Requestable statement of participation and contribution.',
    },
  ];
  ...
  const times = [
    {
      icon: '⏰',
      title: 'Time',
      detail: '~5–10 hours/week (2 live, 3–8 async)',
    },
    {
      icon: '🌎',
      title: 'Timezone',
      detail:
        'Central Time (CT) for live sessions; recordings/notes shared when possible',
    },
    {
      icon: '🤗',
      title: 'Conduct',
      detail: 'Collaborative, inclusive, supportive learning environment',
    },
  ];
    ...
    <>
      ...
      <main className="flex flex-col items-center min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card hover={false}>
              ...
              <div className="divide-y divide-gray-700/40">
                {rhythm.map((item, i) => (
                  <IconBullet key={`rhythm-${i}`} icon={item.icon}>
                    {item.text}
                  </IconBullet>
                ))}
              </div>
            ...
            <Card hover={false}>
              ...
              <div className="mt-6 border-t border-gray-700 pt-6">
                ...
                >
                  ...
                  acceptance criteria met, accessibility checks completed,
                  reviews approved (design/PR), and light documentation added.
                </atoms.Typography>
              </div>
            </Card>
          </div>
        ...
        <Section variant="card">
          ...
          >
            You’ll join a Department (Design, Development, Research, or Product
            Management) and a Product Team. Assignments match your goals, your
            role, and your team’s stage (discovery → iteration → finalization).
          </atoms.Typography>
            ...
            {pathways.map((p) => (
              <Card key={p.name}>
                ...
                <div className="grid gap-2 mb-4">
                  {p.learns.map((t, i) => (
                    <IconBullet key={`l-${p.name}-${i}`}>{t}</IconBullet>
                  ))}
                </div>
                ...
                <div className="grid gap-2 mb-4">
                  {p.skills.map((t, i) => (
                    <IconBullet key={`s-${p.name}-${i}`}>{t}</IconBullet>
                  ))}
                </div>
        ...
        <Section variant="card">
          ...
          <HighlightBox variant="info">
            <atoms.Typography variant="secondary" as="p" size="body_md">
              ...
              impact (e.g., PR merged, component published, research adopted,
              KPI moved).
            </atoms.Typography>
          </HighlightBox>
        </Section>
          ...
          <Card hover={false} className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <atoms.Button
                ...
                as="a"
                href="https://devlaunchers.org/our-mentors-and-instructor-team "
              >
                Meet the Mentors
              </atoms.Button>
              <atoms.Button
